    ...
    ILogger<ProcessOutboxJob> logger) : IJob
{
    ...
    {
        logger.LogInformation("{Module} - Beginning outbox messages processing", ModuleNameString);
        ...
        foreach (var outboxMessage in outboxMessages)
        {
            ...
            {
                logger.LogError(caughtException, "{Module} - Failed processing outbox message {MessageId}", ModuleNameString, outboxMessage.Id);
        ...
        logger.LogInformation("{Module} - Outbox messages processing completed", ModuleNameString);
    }
        ...
        IDbTransaction transaction)
    {
        var sql =
            $"""
             ...
             FROM "ModuleName"."OutboxMessages"
        ...
        Exception? exception)
    {
        const string sql =
            """
            UPDATE "ModuleName"."OutboxMessages"
